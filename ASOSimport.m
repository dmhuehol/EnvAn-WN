...
realfields = {'Date','UTC','PrecipID','PrecipAmt','FrzFreq','Pressure1','Pressure2','Pressure3','Temp','Dewpoint'}; %actual fieldnames; this variable isn't actually used in the output
...
ASOSstruct.date = str2num(datemat); %#ok %sometimes str2num is just better, and the code analyzer can stuff it
