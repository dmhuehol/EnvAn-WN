...
function [presheightvector,geoheightvector] = prestogeo(pressure,temperature,replacefirst,soundstructure,soundingnumber)
try %keeps the function from causing hiccups when used in a long loop scenario
    ...
    disp('Geopotential heights calculated!')
    ...
    switch nargin %different cases occur with different number of input variables, easier than if/elseif
        case 5 %if all inputs are present
